...
macro(CheckFcft)
  if(SDL_FCFT)
    ...
    if(PC_LIBFCFT_FOUND)
      ...
      set(HAVE_FCFT TRUE)
      set(HAVE_LIBFCFT_H 1)
      if(SDL_FCFT_SHARED AND NOT HAVE_SDL_LOADSO)
        message(WARNING "You must have SDL_LoadObject() support for dynamic libfcft loading")
      endif()
      FindLibraryAndSONAME("fcft" LIBDIRS ${PC_LIBFCFT_LIBRARY_DIRS})
      if(SDL_FCFT_SHARED AND FCFT_LIB AND HAVE_SDL_LOADSO)
        set(SDL_LIBFCFT_DYNAMIC "\"${FCFT_LIB_SONAME}\"")
        set(HAVE_FCFT_SHARED TRUE)
        sdl_include_directories(PRIVATE SYSTEM $<TARGET_PROPERTY:PkgConfig::PC_LIBFCFT,INTERFACE_INCLUDE_DIRECTORIES>)
      else()
