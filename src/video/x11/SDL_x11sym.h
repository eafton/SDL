...
SDL_X11_SYM(Bool,XCheckMaskEvent,(Display* a,long b, XEvent *c))
...
SDL_X11_SYM(void,XPutBackEvent,(Display* a,XEvent* b))
...
SDL_X11_SYM(int,XSetClipMask,(Display* a,GC b,Pixmap c))
SDL_X11_SYM(int,XSetRegion,(Display* a,GC b,Region c))
...
SDL_X11_SYM(int,XSubtractRegion,(Region a, Region b, Region c))
