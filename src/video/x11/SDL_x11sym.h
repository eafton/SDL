...
SDL_X11_SYM(int,XFillPolygon,(Display* a,Drawable b,GC c,XPoint *d,int e,int f,int g))
...
SDL_X11_SYM(int,XSetFillStyle,(Display* a,GC b,int c))
...
SDL_X11_SYM(void,XSetTile,(Display* a,GC b,Pixmap c))
