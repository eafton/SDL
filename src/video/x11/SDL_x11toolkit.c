...
static int X11Toolkit_GetMaximumTextHeight(SDL_ToolkitWindowX11 *data, int *asc)
{
#ifdef X_HAVE_UTF8_STRING
    if (data->utf8) {
        XFontSetExtents *extents;
